...
import { Star, ExternalLink, Code2, Search, ArrowUpDown } from "lucide-react"
                    ...
                    <Card tilt glow hover className="p-5">
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex items-start gap-4 flex-1 min-w-0">
                          <div className="hidden sm:block w-14 h-14 rounded-lg overflow-hidden shrink-0 border border-[var(--card-border)]">
                            <img
          ...
          <ScrollReveal>
            <div className="text-center mb-10">
              ...
              <p className="text-sm" style={{ color: "var(--muted)" }}>
                {nonFeatured.length} more projects
              </p>
            </div>
          </ScrollReveal>
