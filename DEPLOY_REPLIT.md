...
| 3D Background | Full Scene3D (40 geometries + 2000 particles) | 2D ParticleField (lighter, wider compat) |
...
| Issue | Solution |
|-------|----------|
| **Blank page on Replit** | Replit's browser container may block WebGL — the `replit` branch uses 2D particles instead of 3D |
